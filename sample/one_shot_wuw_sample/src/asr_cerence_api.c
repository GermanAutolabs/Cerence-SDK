...
nuance_common_ResultCode init_configuration(void)
{
  ...
  config->configDir = "../sample/data/asr/config";
  config->audioConfigDir = "../sample/data/asr/config";
  ...
  config->dccConfigs[nrDccConfigs].cop = "../sample/data/asr/config/songs.cop";
