...
/**
 *  Declaration of nuance_audio_IAudioStreamDistributor class
 ...
 *  @{
 *  @addtogroup IAudioStreamDistributor
 *  @{
 *  @file IAudioStreamDistributor.h
 *
 *  @brief  Interface of the 'AudioStreamDistributor' audio module. <p>
 *
 *  The AudioStreamDistributor (abbr.'ASD') module is capable to map the audio channels of one input stream
 *  to one or more output streams. Means in detail, the ASD is able to reorder, to pick and to fully duplicate
 *  the audio channels of one input stream to one or more output streams.
 */

#ifndef NUANCE_AUDIO_IAUDIOSTREAMDISTRIBUTOR_H
#define NUANCE_AUDIO_IAUDIOSTREAMDISTRIBUTOR_H
 ...
 *  the audio channels of one input stream to one or more output streams.
 */
struct _nuance_audio_IAudioStreamDistributor;
/**
 *  @brief  Interface of the 'AudioStreamDistributor' audio module. <p>
 *
 *  The AudioStreamDistributor (abbr.'ASD') module is capable to map the audio channels of one input stream
 ...
 *  the audio channels of one input stream to one or more output streams.
 */
typedef struct _nuance_audio_IAudioStreamDistributor nuance_audio_IAudioStreamDistributor;
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioStreamDistributor_registerFactory(nuance_audio_IAudioManager *audioManager);


/**
 *  Creates an 'AudioStreamDistributor' audio module instance.
 *
 *  @param[in]     name                     Unique name of this audio module instance.
 *  @param[in]     audioManager             Audio manager instance.
 *  @param[in]     config                   Configuration object.
 *  @param[in]     moduleListener           Listener of this audio module.
 *  @param[out]    audioStreamDistributor   User interface of the created audio module instance.
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioStreamDistributor_create
(
    const LH_CHAR *name,
    ...
    nuance_audio_IAudioStreamDistributor **audioStreamDistributor
);
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioStreamDistributor_getPadNames
(
    const nuance_audio_IAudioStreamDistributor *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_String *nuance_audio_IAudioStreamDistributor_getName(const nuance_audio_IAudioStreamDistributor *instance);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioStreamDistributor_getStatus
(
    nuance_audio_IAudioStreamDistributor *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioStreamDistributor_waitForCompletionWithTimeout
(
    nuance_audio_IAudioStreamDistributor *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundOperation_Status *status
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioStreamDistributor_waitForCompletion
(
    nuance_audio_IAudioStreamDistributor *instance,
    nuance_common_IBackgroundOperation_Status *status
);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioStreamDistributor_waitForCompletionAsync
(
    nuance_audio_IAudioStreamDistributor *instance,
 ...
 *  @return The result code of the execution
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioStreamDistributor_waitForCompletionWithTimeoutAsync
(
    nuance_audio_IAudioStreamDistributor *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundListener *listener
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioStreamDistributor_abortOperation(nuance_audio_IAudioStreamDistributor *instance);


/**
 *  Destructor
 */
AUDIO_C_EXPORT void nuance_audio_IAudioStreamDistributor_destroy(nuance_audio_IAudioStreamDistributor *);


AUDIO_C_EXPORT nuance_audio_IAudioModule *nuance_audio_IAudioStreamDistributor_as_nuance_audio_IAudioModule(nuance_audio_IAudioStreamDistributor *obj);

AUDIO_C_EXPORT nuance_common_IModule *nuance_audio_IAudioStreamDistributor_as_nuance_common_IModule(nuance_audio_IAudioStreamDistributor *obj);

AUDIO_C_EXPORT nuance_common_IBackgroundOperation *nuance_audio_IAudioStreamDistributor_as_nuance_common_IBackgroundOperation(nuance_audio_IAudioStreamDistributor *obj);
...
#endif /* NUANCE_AUDIO_IAUDIOSTREAMDISTRIBUTOR_H */
