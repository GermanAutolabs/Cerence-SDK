...
/**
 *  Declaration of nuance_audio_IAudioEncoder class
 ...
 *  @{
 *  @addtogroup IAudioEncoder
 *  @{
 *  @file IAudioEncoder.h
 *
 *  @brief  Interface of the 'AudioEncoder' audio module. <p>
 *
 *  The 'AudioEncoder' module encodes an incoming 16bit PCM audio data stream using the defined encoder and container.
 *  The output data stream will contain 8bit encoded audio only.
 *  The AudioEncoder will request an IEncoder as well as an IContainerPacker of the configured type during creation at the audio manager.
 *  The IContainerPacker will only be requested if configured.
 *
 *  It has to be ensured that the IEncoder and the IContainerPacker factories were registered at the audio manager via their 'registerFactory' methods before.
 *  If that is not considered the creation of the AudioEncoder will fail with an error.
 */

#ifndef NUANCE_AUDIO_IAUDIOENCODER_H
#define NUANCE_AUDIO_IAUDIOENCODER_H
 ...
 *  If that is not considered the creation of the AudioEncoder will fail with an error.
 */
struct _nuance_audio_IAudioEncoder;
/**
 *  @brief  Interface of the 'AudioEncoder' audio module. <p>
 *
 *  The 'AudioEncoder' module encodes an incoming 16bit PCM audio data stream using the defined encoder and container.
 ...
 *  If that is not considered the creation of the AudioEncoder will fail with an error.
 */
typedef struct _nuance_audio_IAudioEncoder nuance_audio_IAudioEncoder;
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioEncoder_registerFactory(nuance_audio_IAudioManager *audioManager);


/**
 *  Creates an 'AudioEncoder' audio module.
 *
 ...
 *  @param[out]    audioEncoder     User interface of the created audio module instance.
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioEncoder_create
(
    const LH_CHAR *name,
    ...
    nuance_audio_IAudioEncoder **audioEncoder
);
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioEncoder_getPadNames
(
    const nuance_audio_IAudioEncoder *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_String *nuance_audio_IAudioEncoder_getName(const nuance_audio_IAudioEncoder *instance);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioEncoder_getStatus
(
    nuance_audio_IAudioEncoder *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioEncoder_waitForCompletionWithTimeout
(
    nuance_audio_IAudioEncoder *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundOperation_Status *status
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioEncoder_waitForCompletion
(
    nuance_audio_IAudioEncoder *instance,
    nuance_common_IBackgroundOperation_Status *status
);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioEncoder_waitForCompletionAsync
(
    nuance_audio_IAudioEncoder *instance,
 ...
 *  @return The result code of the execution
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioEncoder_waitForCompletionWithTimeoutAsync
(
    nuance_audio_IAudioEncoder *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundListener *listener
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioEncoder_abortOperation(nuance_audio_IAudioEncoder *instance);


/**
 *  Destructor
 */
AUDIO_C_EXPORT void nuance_audio_IAudioEncoder_destroy(nuance_audio_IAudioEncoder *);


AUDIO_C_EXPORT nuance_audio_IAudioModule *nuance_audio_IAudioEncoder_as_nuance_audio_IAudioModule(nuance_audio_IAudioEncoder *obj);

AUDIO_C_EXPORT nuance_common_IModule *nuance_audio_IAudioEncoder_as_nuance_common_IModule(nuance_audio_IAudioEncoder *obj);

AUDIO_C_EXPORT nuance_common_IBackgroundOperation *nuance_audio_IAudioEncoder_as_nuance_common_IBackgroundOperation(nuance_audio_IAudioEncoder *obj);
...
#endif /* NUANCE_AUDIO_IAUDIOENCODER_H */
