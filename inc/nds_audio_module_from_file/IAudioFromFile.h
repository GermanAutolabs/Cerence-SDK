...
/**
 *  Declaration of nuance_audio_IAudioFromFile class
 ...
 *  @{
 *  @addtogroup IAudioFromFile
 *  @{
 *  @file IAudioFromFile.h
 *
 *  @brief  Interface of the 'AudioFromFile' audio module.<p>
 *
 *  In general the AudioFromFile module offers the possibility to stream audio data from an audio file list
 ...
 *  Each start of a session triggers the AudioFromFile audio module to stream the next audio file from the file list.
 *  In case the file list would exceed it is streamed from the beginning again.
 *
 *  The AudioFromFile module is usable in two manifestations:
 *
 *  1. AUTOMATICALLY CREATED WITH A PRE-CONFIGURED AUDIO FILE LIST IN THE AUDIO CONFIGURATION FILE (.json):
 *  With calling prepareScenario() resp. activateScenario() an involved AudioFromFile instance is automatically
 ...
 *  Use the following customer API to create and set up an AudioFromFile module. NOTE: In this use case the
...
#ifndef NUANCE_AUDIO_IAUDIOFROMFILE_H
#define NUANCE_AUDIO_IAUDIOFROMFILE_H
 ...
 *  </ul>
 */
struct _nuance_audio_IAudioFromFile;
/**
 *  @brief  Interface of the 'AudioFromFile' audio module.<p>
 *
 *  In general the AudioFromFile module offers the possibility to stream audio data from an audio file list
 ...
 *  </ul>
 */
typedef struct _nuance_audio_IAudioFromFile nuance_audio_IAudioFromFile;
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_registerFactory(nuance_audio_IAudioManager *audioManager);


/**
 *  Creates an 'IAudioFromFile' audio module instance.
 *
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_create
(
    const LH_CHAR *name,
    ...
    nuance_audio_IAudioFromFile **audioFromFile
);
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_setRootPath
(
    nuance_audio_IAudioFromFile *instance,
 ...
 *  into the general description of the AudioFromFile module above.
 *
 *  NOTE:
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_setFile
(
    nuance_audio_IAudioFromFile *instance,
    const LH_CHAR *file
);
 ...
 *  of the AudioFromFile module above.
 *
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_setFileList
(
    nuance_audio_IAudioFromFile *instance,
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_getPadNames
(
    const nuance_audio_IAudioFromFile *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_String *nuance_audio_IAudioFromFile_getName(const nuance_audio_IAudioFromFile *instance);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_getStatus
(
    nuance_audio_IAudioFromFile *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_waitForCompletionWithTimeout
(
    nuance_audio_IAudioFromFile *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundOperation_Status *status
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_waitForCompletion
(
    nuance_audio_IAudioFromFile *instance,
    nuance_common_IBackgroundOperation_Status *status
);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_waitForCompletionAsync
(
    nuance_audio_IAudioFromFile *instance,
 ...
 *  @return The result code of the execution
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_waitForCompletionWithTimeoutAsync
(
    nuance_audio_IAudioFromFile *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundListener *listener
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioFromFile_abortOperation(nuance_audio_IAudioFromFile *instance);


/**
 *  Destructor
 */
AUDIO_C_EXPORT void nuance_audio_IAudioFromFile_destroy(nuance_audio_IAudioFromFile *);


AUDIO_C_EXPORT nuance_audio_IAudioModule *nuance_audio_IAudioFromFile_as_nuance_audio_IAudioModule(nuance_audio_IAudioFromFile *obj);

AUDIO_C_EXPORT nuance_common_IModule *nuance_audio_IAudioFromFile_as_nuance_common_IModule(nuance_audio_IAudioFromFile *obj);

AUDIO_C_EXPORT nuance_common_IBackgroundOperation *nuance_audio_IAudioFromFile_as_nuance_common_IBackgroundOperation(nuance_audio_IAudioFromFile *obj);
...
#endif /* NUANCE_AUDIO_IAUDIOFROMFILE_H */
