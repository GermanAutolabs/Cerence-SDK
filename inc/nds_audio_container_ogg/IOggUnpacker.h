...
/**
 *  Declaration of nuance_audio_IOggUnpacker class
 ...
 *  @{
 *  @addtogroup IOggUnpacker
 *  @{
 *  @file IOggUnpacker.h
 *
 *  @brief  Interface of the 'OGG' container. <p>
 *
 *  This implementation of the OGG container is able to unpack opus encoded data from the OGG container.
 */

#ifndef NUANCE_AUDIO_IOGGUNPACKER_H
#define NUANCE_AUDIO_IOGGUNPACKER_H
 ...
 *  This implementation of the OGG container is able to unpack opus encoded data from the OGG container.
 */
struct _nuance_audio_IOggUnpacker;
/**
 *  @brief  Interface of the 'OGG' container. <p>
 *
 *  This implementation of the OGG container is able to unpack opus encoded data from the OGG container.
 */
typedef struct _nuance_audio_IOggUnpacker nuance_audio_IOggUnpacker;
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IOggUnpacker_registerFactory(nuance_audio_IAudioManager *audioManager);
...
#endif /* NUANCE_AUDIO_IOGGUNPACKER_H */
