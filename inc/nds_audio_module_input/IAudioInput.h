...
/**
 *  Declaration of nuance_audio_IAudioInput class
 ...
 *  @{
 *  @addtogroup IAudioInput
 *  @{
 *  @file IAudioInput.h
 *
 *  @brief  Interface of the 'AudioInput' audio module. <p>
 *
 *  The 'AudioInput' audio module captures audio from an IAudioInputAdapter interface implementation.
 *  The AudioInput will request an IAudioInputAdapter of the configured type during creation at the audio manager.
 *  Optionally such an adapter implementation can also be passed at creation time to the AudioInput.
 *
 *  A valid adapter implementation needs to be provided, there is no default implementation.
 */

#ifndef NUANCE_AUDIO_IAUDIOINPUT_H
#define NUANCE_AUDIO_IAUDIOINPUT_H
 ...
 *  A valid adapter implementation needs to be provided, there is no default implementation.
 */
struct _nuance_audio_IAudioInput;
/**
 *  @brief  Interface of the 'AudioInput' audio module. <p>
 *
 *  The 'AudioInput' audio module captures audio from an IAudioInputAdapter interface implementation.
 ...
 *  A valid adapter implementation needs to be provided, there is no default implementation.
 */
typedef struct _nuance_audio_IAudioInput nuance_audio_IAudioInput;
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioInput_registerFactory(nuance_audio_IAudioManager *audioManager);


/**
 *  Creates an 'AudioInput' audio module.
 *
 ...
 *  @param[out]    audioInput       User interface of the created audio module instance.
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioInput_create
(
    const LH_CHAR *name,
    ...
    nuance_audio_IAudioInput **audioInput
);


/**
 *  Creates an 'AudioInput' audio module with a dedicated adapter object.
 *
 *  @param[in]     name                Name of the module instance to be created.
 *  @param[in]     audioManager        Audio manager instance.
 *  @param[in]     audioInputAdapter   Audio input adapter instance.
 *  @param[in]     config              Configuration object.
 *  @param[in]     moduleListener      Listener that is informed about module changes (e.g creation finished)
 *  @param[out]    audioInput          User interface of the created audio module instance.
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioInput_createWithAdapter
(
    const LH_CHAR *name,
    nuance_audio_IAudioManager *audioManager,
    nuance_audio_IAudioInputAdapter *audioInputAdapter,
    const nuance_common_IConfiguration *config,
    nuance_common_IModuleListener *moduleListener,
    nuance_audio_IAudioInput **audioInput
);
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioInput_getPadNames
(
    const nuance_audio_IAudioInput *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_String *nuance_audio_IAudioInput_getName(const nuance_audio_IAudioInput *instance);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioInput_getStatus
(
    nuance_audio_IAudioInput *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioInput_waitForCompletionWithTimeout
(
    nuance_audio_IAudioInput *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundOperation_Status *status
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioInput_waitForCompletion
(
    nuance_audio_IAudioInput *instance,
    nuance_common_IBackgroundOperation_Status *status
);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioInput_waitForCompletionAsync
(
    nuance_audio_IAudioInput *instance,
 ...
 *  @return The result code of the execution
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioInput_waitForCompletionWithTimeoutAsync
(
    nuance_audio_IAudioInput *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundListener *listener
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioInput_abortOperation(nuance_audio_IAudioInput *instance);


/**
 *  Destructor
 */
AUDIO_C_EXPORT void nuance_audio_IAudioInput_destroy(nuance_audio_IAudioInput *);


AUDIO_C_EXPORT nuance_audio_IAudioModule *nuance_audio_IAudioInput_as_nuance_audio_IAudioModule(nuance_audio_IAudioInput *obj);

AUDIO_C_EXPORT nuance_common_IModule *nuance_audio_IAudioInput_as_nuance_common_IModule(nuance_audio_IAudioInput *obj);

AUDIO_C_EXPORT nuance_common_IBackgroundOperation *nuance_audio_IAudioInput_as_nuance_common_IBackgroundOperation(nuance_audio_IAudioInput *obj);
...
#endif /* NUANCE_AUDIO_IAUDIOINPUT_H */
