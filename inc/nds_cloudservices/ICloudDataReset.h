...
/**
 *  Declaration of nuance_cloudservices_ICloudDataReset class
 ...
 *  @{
 *  @addtogroup ICloudDataReset
 *  @{
 *  @file ICloudDataReset.h
 *
 *  @brief  Interface of 'CloudDataReset'. <p>
 */

#ifndef NUANCE_CLOUDSERVICES_ICLOUDDATARESET_H
#define NUANCE_CLOUDSERVICES_ICLOUDDATARESET_H
 ...
 *  @brief  Interface of 'CloudDataReset'. <p>
 */
struct _nuance_cloudservices_ICloudDataReset;
/**
 *  @brief  Interface of 'CloudDataReset'. <p>
 */
typedef struct _nuance_cloudservices_ICloudDataReset nuance_cloudservices_ICloudDataReset;
 ...
 *  @return Result code
 */
CLOUDSERVICES_C_EXPORT nuance_common_ResultCode nuance_cloudservices_ICloudDataReset_getStatus
(
    nuance_cloudservices_ICloudDataReset *instance,
 ...
 */
CLOUDSERVICES_C_EXPORT nuance_common_ResultCode nuance_cloudservices_ICloudDataReset_waitForCompletionWithTimeout
(
    nuance_cloudservices_ICloudDataReset *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundOperation_Status *status
 ...
 *  @return Result code
 */
CLOUDSERVICES_C_EXPORT nuance_common_ResultCode nuance_cloudservices_ICloudDataReset_waitForCompletion
(
    nuance_cloudservices_ICloudDataReset *instance,
    nuance_common_IBackgroundOperation_Status *status
);
 ...
 *  @return Result code
 */
CLOUDSERVICES_C_EXPORT nuance_common_ResultCode nuance_cloudservices_ICloudDataReset_waitForCompletionAsync
(
    nuance_cloudservices_ICloudDataReset *instance,
 ...
 *  @return The result code of the execution
 */
CLOUDSERVICES_C_EXPORT nuance_common_ResultCode nuance_cloudservices_ICloudDataReset_waitForCompletionWithTimeoutAsync
(
    nuance_cloudservices_ICloudDataReset *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundListener *listener
 ...
 *  @return Result code
 */
CLOUDSERVICES_C_EXPORT nuance_common_ResultCode nuance_cloudservices_ICloudDataReset_abortOperation(nuance_cloudservices_ICloudDataReset *instance);


/**
 *  Destructor
 */
CLOUDSERVICES_C_EXPORT void nuance_cloudservices_ICloudDataReset_destroy(nuance_cloudservices_ICloudDataReset *);


CLOUDSERVICES_C_EXPORT nuance_common_IBackgroundOperation *nuance_cloudservices_ICloudDataReset_as_nuance_common_IBackgroundOperation(nuance_cloudservices_ICloudDataReset *obj);
...
#endif /* NUANCE_CLOUDSERVICES_ICLOUDDATARESET_H */
