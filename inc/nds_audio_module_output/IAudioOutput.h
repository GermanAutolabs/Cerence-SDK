...
/**
 *  Declaration of nuance_audio_IAudioOutput class
 ...
 *  @{
 *  @addtogroup IAudioOutput
 *  @{
 *  @file IAudioOutput.h
 *
 *  @brief  Interface of the 'AudioOutput' audio module. <p>
 *
 *  The 'AudioOutput' audio module streams audio data to an IAudioOutputAdapter interface implementation.
 *  The AudioInput will request an IAudioInputAdapter of the configured type during creation at the audio manager.
 *  Optionally such an adapter implementation can also be passed at creation time to the AudioOutput.
 *
 *  A valid adapter implementation needs to be provided, there is no default implementation.
 */

#ifndef NUANCE_AUDIO_IAUDIOOUTPUT_H
#define NUANCE_AUDIO_IAUDIOOUTPUT_H
 ...
 *  A valid adapter implementation needs to be provided, there is no default implementation.
 */
struct _nuance_audio_IAudioOutput;
/**
 *  @brief  Interface of the 'AudioOutput' audio module. <p>
 *
 *  The 'AudioOutput' audio module streams audio data to an IAudioOutputAdapter interface implementation.
 ...
 *  A valid adapter implementation needs to be provided, there is no default implementation.
 */
typedef struct _nuance_audio_IAudioOutput nuance_audio_IAudioOutput;
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioOutput_registerFactory(nuance_audio_IAudioManager *audioManager);


/**
 *  Creates an 'AudioOutput' audio module.
 *
 ...
 *  @param[out]    audioOutput      User interface of the created audio module instance.
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioOutput_create
(
    const LH_CHAR *name,
    ...
    nuance_audio_IAudioOutput **audioOutput
);


/**
 *  Creates an 'AudioOutput' audio module with a dedicated adapter object.
 *
 *  @param[in]     name                 Name of the module instance to be created.
 *  @param[in]     audioManager         Audio manager instance.
 *  @param[in]     audioOutputAdapter   Audio output adapter instance.
 *  @param[in]     config               Configuration object.
 *  @param[in]     moduleListener       Listener that is informed about module changes (e.g creation finished)
 *  @param[out]    audioOutput          User interface of the created audio module instance.
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioOutput_createWithAdapter
(
    const LH_CHAR *name,
    nuance_audio_IAudioManager *audioManager,
    nuance_audio_IAudioOutputAdapter *audioOutputAdapter,
    const nuance_common_IConfiguration *config,
    nuance_common_IModuleListener *moduleListener,
    nuance_audio_IAudioOutput **audioOutput
);
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioOutput_getPadNames
(
    const nuance_audio_IAudioOutput *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_String *nuance_audio_IAudioOutput_getName(const nuance_audio_IAudioOutput *instance);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioOutput_getStatus
(
    nuance_audio_IAudioOutput *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioOutput_waitForCompletionWithTimeout
(
    nuance_audio_IAudioOutput *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundOperation_Status *status
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioOutput_waitForCompletion
(
    nuance_audio_IAudioOutput *instance,
    nuance_common_IBackgroundOperation_Status *status
);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioOutput_waitForCompletionAsync
(
    nuance_audio_IAudioOutput *instance,
 ...
 *  @return The result code of the execution
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioOutput_waitForCompletionWithTimeoutAsync
(
    nuance_audio_IAudioOutput *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundListener *listener
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioOutput_abortOperation(nuance_audio_IAudioOutput *instance);


/**
 *  Destructor
 */
AUDIO_C_EXPORT void nuance_audio_IAudioOutput_destroy(nuance_audio_IAudioOutput *);


AUDIO_C_EXPORT nuance_audio_IAudioModule *nuance_audio_IAudioOutput_as_nuance_audio_IAudioModule(nuance_audio_IAudioOutput *obj);

AUDIO_C_EXPORT nuance_common_IModule *nuance_audio_IAudioOutput_as_nuance_common_IModule(nuance_audio_IAudioOutput *obj);

AUDIO_C_EXPORT nuance_common_IBackgroundOperation *nuance_audio_IAudioOutput_as_nuance_common_IBackgroundOperation(nuance_audio_IAudioOutput *obj);
...
#endif /* NUANCE_AUDIO_IAUDIOOUTPUT_H */
