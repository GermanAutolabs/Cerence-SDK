...
/**
 *  Declaration of nuance_audio_IAudioBuffer class
 ...
 *  @{
 *  @addtogroup IAudioBuffer
 *  @{
 *  @file IAudioBuffer.h
 *
 *  @brief  Interface of the 'AudioBuffer' audio module. <p>
 *
 *  The AudioBuffer (AB) module ensures a defined buffer size at the position in the backbone it is placed.
 */

#ifndef NUANCE_AUDIO_IAUDIOBUFFER_H
#define NUANCE_AUDIO_IAUDIOBUFFER_H
 ...
 *  The AudioBuffer (AB) module ensures a defined buffer size at the position in the backbone it is placed.
 */
struct _nuance_audio_IAudioBuffer;
/**
 *  @brief  Interface of the 'AudioBuffer' audio module. <p>
 *
 *  The AudioBuffer (AB) module ensures a defined buffer size at the position in the backbone it is placed.
 */
typedef struct _nuance_audio_IAudioBuffer nuance_audio_IAudioBuffer;
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioBuffer_registerFactory(nuance_audio_IAudioManager *audioManager);


/**
 *  Creates an 'AudioBuffer' audio module instance.
 *
 ...
 *  @param[out]    instanceHandle   User interface of the created audio module instance.
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioBuffer_create
(
    const LH_CHAR *name,
    ...
    nuance_audio_IAudioBuffer **instanceHandle
);
 ...
 *
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioBuffer_getPadNames
(
    const nuance_audio_IAudioBuffer *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_String *nuance_audio_IAudioBuffer_getName(const nuance_audio_IAudioBuffer *instance);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioBuffer_getStatus
(
    nuance_audio_IAudioBuffer *instance,
 ...
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioBuffer_waitForCompletionWithTimeout
(
    nuance_audio_IAudioBuffer *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundOperation_Status *status
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioBuffer_waitForCompletion
(
    nuance_audio_IAudioBuffer *instance,
    nuance_common_IBackgroundOperation_Status *status
);
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioBuffer_waitForCompletionAsync
(
    nuance_audio_IAudioBuffer *instance,
 ...
 *  @return The result code of the execution
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioBuffer_waitForCompletionWithTimeoutAsync
(
    nuance_audio_IAudioBuffer *instance,
    LH_S32 timeout,
    nuance_common_IBackgroundListener *listener
 ...
 *  @return Result code
 */
AUDIO_C_EXPORT nuance_common_ResultCode nuance_audio_IAudioBuffer_abortOperation(nuance_audio_IAudioBuffer *instance);


/**
 *  Destructor
 */
AUDIO_C_EXPORT void nuance_audio_IAudioBuffer_destroy(nuance_audio_IAudioBuffer *);


AUDIO_C_EXPORT nuance_audio_IAudioModule *nuance_audio_IAudioBuffer_as_nuance_audio_IAudioModule(nuance_audio_IAudioBuffer *obj);

AUDIO_C_EXPORT nuance_common_IModule *nuance_audio_IAudioBuffer_as_nuance_common_IModule(nuance_audio_IAudioBuffer *obj);

AUDIO_C_EXPORT nuance_common_IBackgroundOperation *nuance_audio_IAudioBuffer_as_nuance_common_IBackgroundOperation(nuance_audio_IAudioBuffer *obj);
...
#endif /* NUANCE_AUDIO_IAUDIOBUFFER_H */
